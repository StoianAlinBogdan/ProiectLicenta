...
%% pentru ecuatii
\usepackage{amsmath}
%% pentru simboluri logice aditionale
\usepackage{amssymb}
%%pentru notatia bra ket (Dirac)
\usepackage{braket}
...
%%pachet mare de vizualizari si grafici, dar eu il folosesc doar pentru sfere bloch, practic
\usepackage{tikz}
